...
cmx_reentrant 
{
  ...
  a5[0] = alarm[4].enable;
  a5[1] = alarm[4].condition[0].power_reset;
  a5[2] = alarm[4].condition[0].ip_changed;
  a5[3] = alarm[4].condition[0].isvr_accessed;
  a5[4] = alarm[4].condition[0].chars;
  a5[5] = alarm[4].condition[0].isvr_condition;
  a5[6] = alarm[4].condition[0].isvr_disconnect;
  a5[7] = alarm[4].enable;
  a5[8] = alarm[4].enable;
  a5[9] = alarm[4].enable;
...
/*------------------------------------------------------------------------
 Function:    ssi_a5_t_chk()
 Description: SSI: Display whether the Alarm1 checks
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a5_t_chk(byte **str_)
cmx_reentrant 
{
  char str[400];
  char i = 0;
  ...
  a5[0] = alarm[4].enable;
  a5[1] = alarm[4].condition[1].power_reset;
  a5[2] = alarm[4].condition[1].ip_changed;
  a5[3] = alarm[4].condition[1].isvr_accessed;
  a5[4] = alarm[4].condition[1].chars;
  a5[5] = alarm[4].condition[1].isvr_condition;
  a5[6] = alarm[4].condition[1].isvr_disconnect;
  a5[7] = alarm[4].enable;
  a5[8] = alarm[4].enable;
  a5[9] = alarm[4].enable;
...
**************************************************************************************************/
word16 ssi_a5_ic_evt(byte **str_)
cmx_reentrant 
{
  int i;
  char tmp1[400];
  ...
  if(no_of_io > 0)
  {
	...
	memset(str,NULL,sizeof(str));       
  	...
  	sprintf(str,"Input Pin <select name=a5_ip_pin  id=a5_ip_pin> ");
	strcpy(tmp1,str);
	...
	memset(str,NULL,sizeof(str));       
  	memset(s,NULL,sizeof(s));       
  	sprintf(str," Input Condition <select name=a5_pin_cdn  id=a5_pin_cdn> ");
	strcpy(tmp2,str);
...
/*------------------------------------------------------------------------
 Function:    ssi_a5_sic_evt()
 Description: SSI: Display the serial port disconnected
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a5_sic_evt(byte **str_)
cmx_reentrant 
{
  char sic_evt[100];
  ...
  {
    strcpy(sic_evt,"else if(r == 5){ a5_c[1].innerHTML=\"\"; a5_c[2].innerHTML=\"\"; }");
  }
  else
  {
    strcpy(sic_evt,"");
...
/*------------------------------------------------------------------------
 Function:    ssi_a5_sspd()
 Description: SSI: Display the serial port disconnected
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a5_sspd(byte **str_)
cmx_reentrant 
{
  char sspd[2];
