...
cmx_reentrant 
{
  ...
  a3[0] = alarm[2].enable;
  a3[1] = alarm[2].condition[0].power_reset;
  a3[2] = alarm[2].condition[0].ip_changed;
  a3[3] = alarm[2].condition[0].isvr_accessed;
  a3[4] = alarm[2].condition[0].chars;
  a3[5] = alarm[2].condition[0].isvr_condition;
  a3[6] = alarm[2].condition[0].isvr_disconnect;
  a3[7] = alarm[2].enable;
  a3[8] = alarm[2].enable;
  a3[9] = alarm[2].enable;
...
/*------------------------------------------------------------------------
 Function:    ssi_a3_t_chk()
 Description: SSI: Display whether the Alarm1 checks
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a3_t_chk(byte **str_)
cmx_reentrant 
{
  char str[400];
  char i = 0;
  ...
  a3[0] = alarm[2].enable;
  a3[1] = alarm[2].condition[1].power_reset;
  a3[2] = alarm[2].condition[1].ip_changed;
  a3[3] = alarm[2].condition[1].isvr_accessed;
  a3[4] = alarm[2].condition[1].chars;
  a3[5] = alarm[2].condition[1].isvr_condition;
  a3[6] = alarm[2].condition[1].isvr_disconnect;
  a3[7] = alarm[2].enable;
  a3[8] = alarm[2].enable;
  a3[9] = alarm[2].enable;
...
**************************************************************************************************/
word16 ssi_a3_ic_evt(byte **str_)
cmx_reentrant 
{
  int i;
  char tmp1[400];
  ...
  if(no_of_io > 0)
  {
	...
	memset(str,NULL,sizeof(str));       
  	...
  	sprintf(str,"Input Pin <select name=a3_ip_pin  id=a3_ip_pin> ");
	strcpy(tmp1,str);
	...
	memset(str,NULL,sizeof(str));       
  	memset(s,NULL,sizeof(s));       
  	sprintf(str," Input Condition <select name=a3_pin_cdn  id=a3_pin_cdn> ");
	strcpy(tmp2,str);
...
/*------------------------------------------------------------------------
 Function:    ssi_a3_sic_evt()
 Description: SSI: Display the serial port disconnected
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a3_sic_evt(byte **str_)
cmx_reentrant 
{
  char sic_evt[100];
  ...
  {
    strcpy(sic_evt,"else if(r == 5){ a3_c[1].innerHTML=\"\"; a3_c[2].innerHTML=\"\"; }");
  }
  else
  {
    strcpy(sic_evt,"");
...
/*------------------------------------------------------------------------
 Function:    ssi_a3_sspd()
 Description: SSI: Display the serial port disconnected
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a3_sspd(byte **str_)
cmx_reentrant 
{
  char sspd[2];
