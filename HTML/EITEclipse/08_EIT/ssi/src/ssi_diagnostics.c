...
cmx_reentrant 
{
  ...
  /* U1MSR: Bit 4 is CTS status and is 0: when high and 1 when low */
  switch(U1MSR & 0x10) 
  {
...
cmx_reentrant 
{
  ...
  /* U1MCR: Bit 1 is RTS status and is 0: when high and 1 when low */
  switch(U1MCR & 0x02) 
  {
    case 0: strcpy(str,"green.jpg"); break;
    case 1: strcpy(str,"grey.jpg"); break;
...
cmx_reentrant 
{
  ...
  /* U1MSR: Bit 5 is DSR status and is 0: when high and 1 when low */
  switch(U1MSR & 0x20) 
  {
    case 0: strcpy(str,"green.jpg"); break;
    case 1: strcpy(str,"grey.jpg"); break;
...
cmx_reentrant 
{
  ...
  /* U1MSR: Bit 7 is DCD status and is 0: when high and 1 when low */
  switch(U1MSR & 0x80) 
  {
    case 0: strcpy(str,"green.jpg"); break;
    case 1: strcpy(str,"grey.jpg"); break;
...
cmx_reentrant 
{
  ...
  /* U1MCR: Bit 0 is DTR status and is 0: when high and 1 when low */
  switch(U1MCR & 0x01) 
  {
    case 0: strcpy(str,"green.jpg"); break;
    case 1: strcpy(str,"grey.jpg"); break;
