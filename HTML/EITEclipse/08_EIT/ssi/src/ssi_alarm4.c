...
cmx_reentrant 
{
  ...
  a4[0] = alarm[3].enable;
  a4[1] = alarm[3].condition[0].power_reset;
  a4[2] = alarm[3].condition[0].ip_changed;
  a4[3] = alarm[3].condition[0].isvr_accessed;
  a4[4] = alarm[3].condition[0].chars;
  a4[5] = alarm[3].condition[0].isvr_condition;
  a4[6] = alarm[3].condition[0].isvr_disconnect;
  a4[7] = alarm[3].enable;
  a4[8] = alarm[3].enable;
  a4[9] = alarm[3].enable;
...
/*------------------------------------------------------------------------
 Function:    ssi_a4_t_chk()
 Description: SSI: Display whether the Alarm1 checks
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a4_t_chk(byte **str_)
cmx_reentrant 
{
  char str[400];
  char i = 0;
  ...
  a4[0] = alarm[3].enable;
  a4[1] = alarm[3].condition[1].power_reset;
  a4[2] = alarm[3].condition[1].ip_changed;
  a4[3] = alarm[3].condition[1].isvr_accessed;
  a4[4] = alarm[3].condition[1].chars;
  a4[5] = alarm[3].condition[1].isvr_condition;
  a4[6] = alarm[3].condition[1].isvr_disconnect;
  a4[7] = alarm[3].enable;
  a4[8] = alarm[3].enable;
  a4[9] = alarm[3].enable;
...
**************************************************************************************************/
word16 ssi_a4_ic_evt(byte **str_)
cmx_reentrant 
{
  int i;
  char tmp1[400];
  ...
  if(no_of_io > 0)
  {
	...
	memset(str,NULL,sizeof(str));       
  	...
  	sprintf(str,"Input Pin <select name=a4_ip_pin  id=a4_ip_pin> ");
	strcpy(tmp1,str);
	...
	memset(str,NULL,sizeof(str));       
  	memset(s,NULL,sizeof(s));       
  	sprintf(str," Input Condition <select name=a4_pin_cdn  id=a4_pin_cdn> ");
	strcpy(tmp2,str);

    switch(alarm[3].pin_condition)  /* Selected Parity = "selected", else " " */
    {
      case 1:  strcpy(s[0],"selected=\\\"selected\\\"");  break;
      case 2:  strcpy(s[1],"selected=\\\"selected\\\"");  break;
    }
...
/*------------------------------------------------------------------------
 Function:    ssi_a4_sic_evt()
 Description: SSI: Display the serial port disconnected
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a4_sic_evt(byte **str_)
cmx_reentrant 
{
  char sic_evt[100];
  ...
  {
    strcpy(sic_evt,"else if(r == 5){ a4_c[1].innerHTML=\"\"; a4_c[2].innerHTML=\"\"; }");
  }
  else
  {
    strcpy(sic_evt,"");
...
/*------------------------------------------------------------------------
 Function:    ssi_a4_sspd()
 Description: SSI: Display the serial port disconnected
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a4_sspd(byte **str_)
cmx_reentrant 
{
  char sspd[2];
