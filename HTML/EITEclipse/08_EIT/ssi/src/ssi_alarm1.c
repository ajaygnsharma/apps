...
cmx_reentrant 
{
  ...
  a1[0] = alarm[0].enable;
  a1[1] = alarm[0].condition[0].power_reset;
  a1[2] = alarm[0].condition[0].ip_changed;
  a1[3] = alarm[0].condition[0].isvr_accessed;
  a1[4] = alarm[0].condition[0].chars;
  a1[5] = alarm[0].condition[0].isvr_condition;
  a1[6] = alarm[0].condition[0].isvr_disconnect;
  a1[7] = alarm[0].enable;
  a1[8] = alarm[0].enable;
  a1[9] = alarm[0].enable;
...
/*------------------------------------------------------------------------
 Function:    ssi_a1_t_chk()
 Description: SSI: Display whether the Alarm1 checks
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a1_t_chk(byte **str_)
cmx_reentrant 
{
  char str[400];
  char i = 0;
  ...
  a1[0] = alarm[0].enable;
  a1[1] = alarm[0].condition[1].power_reset;
  a1[2] = alarm[0].condition[1].ip_changed;
  a1[3] = alarm[0].condition[1].isvr_accessed;
  a1[4] = alarm[0].condition[1].chars;
  a1[5] = alarm[0].condition[1].isvr_condition;
  a1[6] = alarm[0].condition[1].isvr_disconnect;
  a1[7] = alarm[0].enable;
  a1[8] = alarm[0].enable;
  a1[9] = alarm[0].enable;
...
**************************************************************************************************/
word16 ssi_a1_ic_evt(byte **str_)
cmx_reentrant 
{
  int i;
  char tmp1[400];
  ...
  if(no_of_io > 0)
  {
	...
	memset(str,NULL,sizeof(str));       
  	...
  	sprintf(str,"Input Pin <select name=a1_ip_pin  id=a1_ip_pin> ");
	strcpy(tmp1,str);
	...
	memset(str,NULL,sizeof(str));       
  	memset(s,NULL,sizeof(s));       
  	sprintf(str," Input Condition <select name=a1_pin_cdn  id=a1_pin_cdn> ");
	strcpy(tmp2,str);
...
/*------------------------------------------------------------------------
 Function:    ssi_a1_sic_evt()
 Description: SSI: Display the serial port disconnected
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a1_sic_evt(byte **str_)
cmx_reentrant 
{
  char sic_evt[100];
  ...
  {
    strcpy(sic_evt,"else if(r == 5){ a1_c[1].innerHTML=\"\"; a1_c[2].innerHTML=\"\"; }");
  }
  else
  {
    strcpy(sic_evt,"");
...
/*------------------------------------------------------------------------
 Function:    ssi_a1_sspd()
 Description: SSI: Display the serial port disconnected
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a1_sspd(byte **str_)
cmx_reentrant 
{
  char sspd[2];
...
cmx_reentrant 
{
  ...
  sprintf(str,"%d",alarm[0].reminder_interval);
