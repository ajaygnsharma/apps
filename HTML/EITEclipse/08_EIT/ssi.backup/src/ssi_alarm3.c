...
/*------------------------------------------------------------------------
 Function:    ssi_a3_e_pr()
 Description: SSI: Display whether the Email in Alarm1 is enabled or not
              Enabled/Disabled   
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a3_e_pr(byte **str_)
cmx_reentrant 
{
  char str[10];
  
  switch(alarm[2].condition[0].power_reset)
  {
    case 0: strcpy(str," "); break;
    case 1: strcpy(str,"checked"); break;
    default: strcpy(str," "); break;
...
/*------------------------------------------------------------------------
 Function:    ssi_a3_t_pr()
 Description: SSI: Display whether the trap in Alarm3 is enabled or not 
              Enabled/Disabled   
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a3_t_pr(byte **str_)
cmx_reentrant 
{
  char str[10];
  
  switch(alarm[2].condition[1].power_reset)
  {
    case 0: strcpy(str," "); break;
    case 1: strcpy(str,"checked"); break;
    default: strcpy(str," "); break;
...
/*------------------------------------------------------------------------
 Function:    ssi_a3_e_ipc()
 Description: SSI: Display whether the IP Changed Email in Alarm3 is 
              enabled or not 
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a3_e_ipc(byte **str_)
cmx_reentrant 
{
  char str[10];
  
  switch(alarm[2].condition[0].ip_changed)
  {
    case 0: strcpy(str," "); break;
    case 1: strcpy(str,"checked"); break;
    default: strcpy(str," "); break;
...
/*------------------------------------------------------------------------
 Function:    ssi_a3_t_ipc()
 Description: SSI: Display whether the IP Changed trap in Alarm3 is 
              enabled or not 
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a3_t_ipc(byte **str_)
cmx_reentrant
{
  char str[10];
  
  switch(alarm[2].condition[1].ip_changed)
  {
    case 0: strcpy(str," "); break;
    case 1: strcpy(str,"checked"); break;
    default: strcpy(str," "); break;
...
/*------------------------------------------------------------------------
 Function:    ssi_a3_e_isa()
 Description: SSI: Display whether the Iserver was accessed in Alarm3 is 
              enabled or not 
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a3_e_isa(byte **str_)
cmx_reentrant 
{
  char str[10];
  
  switch(alarm[2].condition[0].isvr_accessed)
  {
    case 0: strcpy(str," "); break;
    case 1: strcpy(str,"checked"); break;
    default: strcpy(str," "); break;
...
/*------------------------------------------------------------------------
 Function:    ssi_a3_t_isa()
 Description: SSI: Display whether the Iserver was accessed in Alarm3 is 
              enabled or not 
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a3_t_isa(byte **str_)
cmx_reentrant
{
  char str[10];
  
  switch(alarm[2].condition[1].isvr_accessed)
  {
    case 0: strcpy(str," "); break;
    case 1: strcpy(str,"checked"); break;
    default: strcpy(str," "); break;
...
/*------------------------------------------------------------------------
 Function:    ssi_a3_e_spd()
 Description: SSI: Display whether the Serial Port is connected or not 
              Alarm3 is enabled or not 
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a3_e_spd(byte **str_)
cmx_reentrant 
{
  char str[10];
  
  switch(alarm[2].condition[0].isvr_disconnect)
  {
    case 0: strcpy(str," "); break;
    case 1: strcpy(str,"checked"); break;
    default: strcpy(str," "); break;
...
/*------------------------------------------------------------------------
 Function:    ssi_a3_t_spd()
 Description: SSI: Display whether the Serial Port  is connected or not 
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a3_t_spd(byte **str_)
cmx_reentrant
{
  char str[10];
  
  switch(alarm[2].condition[1].isvr_disconnect)
  {
    case 0: strcpy(str," "); break;
    case 1: strcpy(str,"checked"); break;
    default: strcpy(str," "); break;
...
------------------------------------------------------------------------*/
word16 ssi_a3_ip_pin(byte **str_)
cmx_reentrant 
{
  ...
  switch(alarm[2].input_pin)  /* Selected Parity = "selected", else " " */
  {
  ...
  sprintf(str[0],"<select name=\"a3_ip_pin\">\r\n");
  strcpy(tmp,str[0]);
...
/*------------------------------------------------------------------------
  Function:    ssi_a3_pin_cdn()
  Description: Output the pin condition selection menu
  Input:       Pointer to the String Selection Menu String
  Output:      Length of the Menu String
------------------------------------------------------------------------*/
word16 ssi_a3_pin_cdn(byte **str_)
cmx_reentrant 
{
  int i;
  ...
  switch(alarm[2].pin_condition)  /* Selected Parity = "selected", else " " */
  {
    case 1:  strcpy(s[0],SELECTED);  break;
    case 2:  strcpy(s[1],SELECTED);  break;
    default: strcpy(s[0],SELECTED);  break;
  ...
  sprintf(str[0],"<select name=\"a3_pin_cdn\">\r\n");
  strcpy(tmp,str[0]);
...
/*------------------------------------------------------------------------
 Function:    ssi_a3_e_ic()
 Description: SSI: Display whether email alarm for Input Pin Condition 
              is enabled or not?
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a3_e_ic(byte **str_)
cmx_reentrant 
{
  char str[10];
  
  switch(alarm[2].condition[0].isvr_condition)
  {
    case 0: strcpy(str," "); break;
    case 1: strcpy(str,"checked"); break;
    default: strcpy(str," "); break;
...
/*------------------------------------------------------------------------
 Function:    ssi_a3_t_ic()
 Description: SSI: Display whether TRAP alarm for Input Pin Condition is
              enabled or not?
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a3_t_ic(byte **str_)
cmx_reentrant
{
  char str[10];
  
  switch(alarm[2].condition[1].isvr_condition)
  {
    case 0: strcpy(str," "); break;
    case 1: strcpy(str,"checked"); break;
    default: strcpy(str," "); break;
...
/*------------------------------------------------------------------------
 ...
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a3_e_c(byte **str_)
cmx_reentrant 
{
  char str[10];
  
  switch(alarm[2].condition[0].chars)
  {
    case 0: strcpy(str," "); break;
    case 1: strcpy(str,"checked"); break;
    default: strcpy(str," "); break;
...
/*------------------------------------------------------------------------
 ...
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a3_t_c(byte **str_)
cmx_reentrant
{
  char str[10];
  
  switch(alarm[2].condition[1].chars)
  {
    case 0: strcpy(str," "); break;
    case 1: strcpy(str,"checked"); break;
    default: strcpy(str," "); break;
...
/*------------------------------------------------------------------------
 Function:    ssi_a3_char1()
 Description: SSI: Display the Reminder Interval
 Input:       String containing Status
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a3_char1(byte **str_)
cmx_reentrant 
{
  char str[10];
  
  sprintf(str,"%X",alarm[2].char1);
...
/*------------------------------------------------------------------------
 ...
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a3_char2(byte **str_)
cmx_reentrant 
{
  char str[10];
  
  sprintf(str,"%X",alarm[2].char2);
...
/*------------------------------------------------------------------------
 ...
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a3_ri(byte **str_)
cmx_reentrant 
{
  char str[10];
  
  sprintf(str,"%d",alarm[2].reminder_interval);
...
/*------------------------------------------------------------------------
 ...
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a3_to(byte **str_)
cmx_reentrant 
{
  char str[50 + 1];
  
  //sprintf(str,"%s",alarm[0].recipients);
  strcpy(str,alarm[2].recipients);  
...
/*------------------------------------------------------------------------
 ...
 Output:      Length of Response
------------------------------------------------------------------------*/
word16 ssi_a3_msg(byte **str_)
cmx_reentrant 
{
  char str[30 + 1];
  
  //sprintf(str,"%s",alarm[0].msg);
  strcpy(str,alarm[2].msg);    
