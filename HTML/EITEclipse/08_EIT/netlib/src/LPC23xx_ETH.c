...
//#endif         /* AUTO_NEGOTIATE */
   ...
   id2 = mii_read(phy_addr, PHY_REG_IDR2) & _PHY_ID2_MASK;
   if ((id1 == DP83848C_ID1) && (id2 == (DP83848C_ID2 & _PHY_ID2_MASK)))
      {
      retval = -6;
#if (DO_DEBUG)
   ...
   else if (((id1 == KS8721BL_ID1) && (id2 == (KS8721BL_ID2 & _PHY_ID2_MASK))) || \
         ((id1 == KSZ8041NL_ID1) && (id2 == (KSZ8041NL_ID2 & _PHY_ID2_MASK))))
      {
      retval = -6;
#if (DO_DEBUG)
      if (id2 == (KS8721BL_ID2 & _PHY_ID2_MASK))
         DiagSend("KS8721BL or KSZ8001L PHY detected\r\n");
      else if (id2 == (KSZ8041NL_ID2 & _PHY_ID2_MASK))
