...
project = "Readme Firmware Files for RXI-CH"  # or set dynamically elsewhere
author  = "Ajay Sharma"
release = "B"  # from cfg.ini (REV)
family  = "RXI-CH"  # from cfg.ini (FAMILY)
doc_number = "FWF-23821-RM01"
...
\newcommand{\DocNumber}{FWF-23821-RM01}
\newcommand{\DocDescription}{Readme Firmware Files for RXI-CH}
...
\\renewcommand{{\\DocDescription}}{{Readme Firmware Files for {family}}}
"""

# Project title for the ZIP Readme PDF
project = f"Readme Firmware Files for {family}"


# (rest of conf.py)
latex_additional_files = ["_static/logo.png"]
latex_documents = [
    ("index", "rxi_ch_manuals.tex", project, "", "howto"),
]
