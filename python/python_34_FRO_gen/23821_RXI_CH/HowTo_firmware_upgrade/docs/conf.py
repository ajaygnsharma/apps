...
project = "How to upgrade Firmware for RXI"  # or set dynamically elsewhere
author  = "Ajay Sharma"
release = "0106"  # from cfg.ini (REV)
family  = "RXI-CH"  # from cfg.ini (FAMILY)
doc_number = "FRN-23821-0SWU"
...
\newcommand{\DocNumber}{FRN-23821-0SWU}
\newcommand{\DocDescription}{Release Notes for ['RXI-CH']}
...
\\renewcommand{{\\DocDescription}}{{How to upgrade Firmware for {family}}}
"""
