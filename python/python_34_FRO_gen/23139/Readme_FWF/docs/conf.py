...
project = "Readme Firmware Files for IBB"  # or set dynamically elsewhere
author  = "Ajay Sharma"
release = "A"  # from cfg.ini (REV)
family  = "IBB"  # from cfg.ini (FAMILY)
doc_number = "FWF-23139-RM01"
...
\newcommand{\DocNumber}{FWF-23139-RM01}
\newcommand{\DocDescription}{Readme Firmware Files for IBB}
...
latex_documents = [
    ("index", "ibb_manuals.tex", project, "", "howto"),
]
