...
project = "Release Notes for RXR/RXI"  # or set dynamically elsewhere
author  = "Ajay Sharma"
release = "0109"  # from cfg.ini (REV)
family  = "RXR/RXI"  # from cfg.ini (FAMILY)
doc_number = "FRN-23820-0BIN"
