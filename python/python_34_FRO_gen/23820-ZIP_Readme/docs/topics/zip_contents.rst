...
RX1+1 with TERX serial number ZIP-23820-0001.zip contains the following

Files:

    1. ReadMeFirst.txt - First read this file
    2. FirmwareUpgradeProcedure.pdf - The process of upgrading firmware is described in this.
    3. rx_arm_fwV1_0X.bin - The main firmware binary for RX1+1
