...
project = "Readme Firmware Files for IBD"  # or set dynamically elsewhere
author  = "Ajay Sharma"
release = "B"  # from cfg.ini (REV)
family  = "IBD"  # from cfg.ini (FAMILY)
doc_number = "FWF-23818-RM01"
...
\newcommand{\DocNumber}{FWF-23818-RM01}
\newcommand{\DocDescription}{Readme Firmware Files for IBD}
...
latex_documents = [
    ("index", "ibd_manuals.tex", project, "", "howto"),
]
