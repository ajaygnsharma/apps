...
project = "Release Notes for TXI 1:2"  # or set dynamically elsewhere
author  = "Ajay Sharma"
release = "0110"  # from cfg.ini (REV)
family  = "TXI 1:2"  # from cfg.ini (FAMILY)
doc_number = "FRN-23719-0SWU"
