...
void fibonacci()
{
	 ...
	 * if a,b,c are regular vars   : exec time = 0.000125  msec
	 * if a,b,c are register vars  : exec time = 0.000115  msec
	 * if a,b,c,n are register vars: exec time = 0.000060 msec
	 * on arm7 = 0.023179 msec (386 times slower)
	 */
